...
class TrainingCenterPermissionSeeder extends Seeder
{
    public function run(): void
    {
        $permissions = [
            ...
            ['slug' => 'training_center.batches.view',        'name' => 'View Batches',        'module' => 'training_center.batches'],
            ['slug' => 'training_center.batches.manage',      'name' => 'Manage Batches',      'module' => 'training_center.batches'],
            ['slug' => 'training_center.trainees.view',       'name' => 'View Trainees',       'module' => 'training_center.trainees'],
            ['slug' => 'training_center.trainees.manage',     'name' => 'Manage Trainees',     'module' => 'training_center.trainees'],
