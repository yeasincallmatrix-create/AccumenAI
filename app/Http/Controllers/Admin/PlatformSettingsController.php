...
class PlatformSettingsController extends Controller
{
    private function viewData(Request $request): array
    {
        return [
            ...
            'timezone' => Setting::get('app.timezone', config('locale.date.timezone', 'Asia/Dhaka')),
            'country' => Setting::get('app.country', config('locale.country.default_iso2', 'BD')),
            'currency' => Setting::get('app.currency', config('locale.currency.default_code', 'BDT')),
            ...
            'mapsCountry' => Setting::get('maps.default_country', config('locale.country.default_iso2', 'BD')),
            'mapsLat' => Setting::get('maps.default_lat', config('locale.geo.default_lat', '23.8103')),
            'mapsLng' => Setting::get('maps.default_lng', config('locale.geo.default_lng', '90.4125')),
            ...
            'payCurrency' => Setting::get('payment.currency', config('locale.currency.default_code', 'BDT')),
