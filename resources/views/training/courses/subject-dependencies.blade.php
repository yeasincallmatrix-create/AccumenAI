    ...
    <div class="card-body">
        <div class="alert alert-info mb-4">
            ...
            <div class="row text-center small">
                <div class="col-md-3">
                    <div class="fw-bold">{{ $classification['counts']['training_course_subjects'] ?? 0 }}</div>
                    <div class="text-muted">Course Subjects</div>
                </div>
                <div class="col-md-3">
                    <div class="fw-bold">{{ $classification['counts']['training_exam_results'] ?? 0 }}</div>
                ...
                <tbody>
                    @foreach ($details as $key => $count)
                        <tr>
                            ...
                            <td>
                                @if ($count > 0)
                                    @if (in_array($key, ['training_exam_results'], true))
