...
<div class="page-header">
    ...
    <div class="page-header-actions">
        <a href="{{ route('training.courses.subjects.index') }}" class="btn btn-outline-secondary btn-sm">
...
<div class="admin-card">
    <form id="subjectForm" method="POST" action="{{ $subject ? route('training.courses.subjects.update', $subject) : route('training.courses.subjects.store') }}" data-ajax-enabled>
        @csrf
        @if ($subject)
            @method('PUT')
        @endif
        ...
        <div class="card-footer border-top d-flex justify-content-end gap-2">
            <a href="{{ route('training.courses.subjects.index') }}" class="btn btn-outline-secondary">Cancel</a>
