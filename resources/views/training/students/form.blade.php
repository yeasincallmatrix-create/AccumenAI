...
<div class="page-header">
    ...
    <div class="page-header-actions d-flex gap-2">
        ...
        <a class="btn btn-outline-secondary" href="{{ route('training.students.index') }}">
...
<form method="POST" action="{{ $student->exists ? route('training.students.update', $student) : route('training.students.store') }}" enctype="multipart/form-data">
    @csrf
    @if($student->exists)
        @method('PUT')
    @endif
...
<label for="photo">Profile Picture</label>
        ...
        <div class="form-footer">
            <a class="btn btn-outline-secondary" href="{{ route('training.students.index') }}">Cancel</a>
