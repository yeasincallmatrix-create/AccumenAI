                ...
                <div class="auth-card mb-3">
                    <div class="text-center">
                        ...
                        <div class="mb-2">
                            ...
                            <span class="badge text-bg-secondary ms-1">{{ mawa_lang('workspace.step2_of_2') }}</span>
                        </div>
                        <h1 class="auth-title h3 mb-2">{{ mawa_e('auth.owner_account_details_title') }}</h1>
                        <p class="auth-subtitle mb-4">{{ mawa_e('auth.owner_account_details_hint') }}</p>
                    </div>
                    ...
                    <div class="card border mb-4">
                        <div class="card-body py-3">
                            <div class="row g-2 align-items-center">
                                ...
                                <div class="col-auto">
                                    <a href="{{ route('owner.register') }}" class="btn btn-sm btn-outline-secondary">
                                        <i class="bi bi-arrow-repeat"></i> {{ mawa_e('auth.owner_change_selection') }}
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <form method="POST" action="{{ route('owner.register.submit') }}">
                        ...
                        <div class="row g-3 mt-0">
                            ...
                            <div class="col-md-6">
                                ...
                                @include('partials.phone', ['name' => 'phone', 'id' => 'phone', 'value' => old('phone'), 'required' => true, 'country' => $selection['country']])
                            </div>
                        </div>
