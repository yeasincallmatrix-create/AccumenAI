        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <h1 class="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-gray-900 leading-tight">
                    {!! Str::markdown($homePage->hero_title) !!}
                </h1>
...
<section id="industries" class="py-20 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-3xl mx-auto mb-12">
            ...
            <p class="mt-4 text-gray-600">One platform, tailored solutions — switch domains without losing data.</p>
        </div>
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
            @php
                $industries = $homePage->sections_json['industries'] ?? [
                    ...
                    ['Restaurant', 'bi-cup-hot-fill', 'from-orange-500 to-red-600', 'Restaurants & Cafes'],
        ...
        <div class="grid md:grid-cols-3 gap-8">
            @php
                $testimonials = $homePage->sections_json['testimonials'] ?? [
                    ...
                    ['Imran Hossain', 'Director, SkillUp Institute', 'Certificates with QR verification and training batches — perfect for our training center. Super easy to use!', '198754', '4.5'],
                ];
            @endphp
...
<footer class="bg-gray-900 text-gray-300 py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid md:grid-cols-4 gap-8 mb-8">
            <div>
                <div class="flex items-center gap-2 mb-4"><div class="w-8 h-8 rounded-lg bg-blue-600 flex items-center justify-center text-white font-bold">A</div><span class="text-white font-bold text-lg">{{ $platformBrandName ?? 'AccumenAI' }}</span></div>
