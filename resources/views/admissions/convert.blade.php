    ...
    <div class="student-form-card">
        ...
        <div class="grid">
            <div class="field">
                ...
                <x-tdate-input id="application_date" name="application_date" value="{{ old('application_date', now()->format('Y-m-d')) }}" required />
        ...
        <div class="grid">
            ...
            <div class="field">
                ...
                <x-tdate-input id="dob" name="dob" value="{{ old('dob') }}" />
