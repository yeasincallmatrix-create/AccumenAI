...
<form method="GET" class="admin-card p-3 mb-3 row g-2">
    ...
    <div class="col-md-3"><x-tdate-input name="from" :value="request('from')" class="form-control form-control-sm" placeholder="From" /></div>
    <div class="col-md-3"><x-tdate-input name="to" :value="request('to')" class="form-control form-control-sm" placeholder="To" /></div>
