...
<div class="admin-card p-3">
    <form method="POST" action="{{ route('hr.leave.applications.store') }}" enctype="multipart/form-data">
        ...
        <div class="row g-2">
            ...
            <div class="col-md-2"><label class="form-label small">Start *</label><x-tdate-input name="start_date" class="form-control form-control-sm" required /></div>
            <div class="col-md-2"><label class="form-label small">End *</label><x-tdate-input name="end_date" class="form-control form-control-sm" required /></div>
