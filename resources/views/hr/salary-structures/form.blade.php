...
<div class="admin-card p-3">
    <form method="POST" action="{{ $structure?route('hr.salary-structures.update',$structure):route('hr.salary-structures.store') }}">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-4"><label class="form-label">Effective From *</label><x-tdate-input name="effective_from" :value="old('effective_from',isset($structure)?$structure->effective_from->format('Y-m-d'):now()->toDateString())" class="form-control form-control-sm" required /></div>
