...
@section('title', 'Edit Vitals — AccumenAI')

@section('content')
<div class="page-header d-flex flex-wrap align-items-center justify-content-between gap-2">
    <div class="page-header-text">
        <h4 class="page-header-title">Edit Vitals — {{ $contextLabel }}</h4>
    </div>
...
<div class="card">
    <div class="card-body">
        <form action="{{ route('medical.vitals.update', $vital) }}" method="POST">
            @csrf
            @method('PUT')
            {{-- Context linkage (re-validated, then ignored — linkage is immutable). --}}
            @if($vital->admission_id)
                <input type="hidden" name="admission_id" value="{{ $vital->admission_id }}">
            @else
                <input type="hidden" name="appointment_id" value="{{ $vital->appointment_id }}">
            @endif
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="number" id="temperature" name="temperature" step="0.1" min="35" max="42"
                               ...
                               value="{{ old('temperature', $vital->temperature) }}" placeholder="e.g. 37.5">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="number" id="blood_pressure_systolic" name="blood_pressure_systolic" min="60" max="250"
                               ...
                               value="{{ old('blood_pressure_systolic', $vital->blood_pressure_systolic) }}" placeholder="e.g. 120">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="number" id="blood_pressure_diastolic" name="blood_pressure_diastolic" min="30" max="150"
                               ...
                               value="{{ old('blood_pressure_diastolic', $vital->blood_pressure_diastolic) }}" placeholder="e.g. 80">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="number" id="pulse" name="pulse" min="30" max="250"
                               ...
                               value="{{ old('pulse', $vital->pulse) }}" placeholder="e.g. 72">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="number" id="heart_rate" name="heart_rate" min="30" max="250"
                               class="form-control @error('heart_rate') is-invalid @enderror"
                               value="{{ old('heart_rate', $vital->heart_rate) }}" placeholder="e.g. 72">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="number" id="respiratory_rate" name="respiratory_rate" min="5" max="60"
                               ...
                               value="{{ old('respiratory_rate', $vital->respiratory_rate) }}" placeholder="e.g. 16">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="number" id="spo2" name="spo2" min="70" max="100"
                               ...
                               value="{{ old('spo2', $vital->spo2) }}" placeholder="e.g. 98">
                        @error('spo2')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="mb-3">
                        <label class="form-label" for="pain_score">Pain Score (0–10)</label>
                        <input type="number" id="pain_score" name="pain_score" min="0" max="10"
                               class="form-control @error('pain_score') is-invalid @enderror"
                               value="{{ old('pain_score', $vital->pain_score) }}" placeholder="e.g. 3">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="number" id="blood_sugar" name="blood_sugar" step="0.1" min="20" max="500"
                               ...
                               value="{{ old('blood_sugar', $vital->blood_sugar) }}" placeholder="e.g. 110">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="number" id="weight" name="weight" step="0.1" min="1" max="300"
                               ...
                               value="{{ old('weight', $vital->weight) }}" placeholder="e.g. 65">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="number" id="height" name="height" step="0.1" min="30" max="250"
                                   ...
                                   value="{{ old('height', $vital->height) }}" placeholder="e.g. 170">
                ...
                <div class="col-md-12">
                    <div class="mb-3">
                        ...
                        <textarea id="notes" name="notes" rows="2"
                                  class="form-control @error('notes') is-invalid @enderror">{{ old('notes', $vital->notes) }}</textarea>
            ...
            <button type="submit" class="btn btn-primary">
                <i class="bi bi-save me-1"></i>Update Vitals
            </button>
