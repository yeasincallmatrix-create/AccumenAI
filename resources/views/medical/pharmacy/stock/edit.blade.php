            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <x-tdate-input name="manufacturing_date" :value="old('manufacturing_date', $stock->manufacturing_date?->format('Y-m-d'))" id="manufacturing_date" :class="'form-control'.($errors->has('manufacturing_date') ? ' is-invalid' : '')" />
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <x-tdate-input name="expiry_date" :value="old('expiry_date', $stock->expiry_date?->format('Y-m-d'))" id="expiry_date" :class="'form-control'.($errors->has('expiry_date') ? ' is-invalid' : '')" required />
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <x-tdate-input name="received_date" :value="old('received_date', $stock->received_date?->format('Y-m-d'))" id="received_date" :class="'form-control'.($errors->has('received_date') ? ' is-invalid' : '')" />
