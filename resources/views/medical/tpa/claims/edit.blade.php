...
@section('title', 'Edit TPA Claim — AccumenAI')

@section('content')
<div class="page-header d-flex flex-wrap align-items-center justify-content-between gap-2">
    <div class="page-header-text">
        <h4 class="page-header-title">Edit Claim — {{ clinical_no($claim->claim_number) }}</h4>
    </div>
    <div class="page-header-actions">
        <a class="btn btn-secondary" href="{{ route('medical.tpa.claims.show', $claim) }}">
...
<div class="alert alert-info">
    ...
    Only <strong>pending</strong> claims can be edited.
</div>

<div class="card">
    <div class="card-body">
        <form action="{{ route('medical.tpa.claims.update', $claim) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-md-6">
                        ...
                        <select id="patient_id" name="patient_id" class="form-select @error('patient_id') is-invalid @enderror" required>
                            ...
                            @foreach($patients as $patient)
                                <option value="{{ $patient->id }}"
                                    @selected((string) old('patient_id', $claim->patient_id) === (string) $patient->id)>
                        ...
                        <select id="invoice_id" name="invoice_id" class="form-select @error('invoice_id') is-invalid @enderror" required>
                            ...
                            @foreach($invoices as $invoice)
                                <option value="{{ $invoice->id }}"
                                    @selected((string) old('invoice_id', $claim->invoice_id) === (string) $invoice->id)>
                                    {{ clinical_no($invoice->invoice_number) }} — {{ $invoice->patient->full_name ?? '' }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" id="tpa_company_name" name="tpa_company_name" maxlength="150"
                               ...
                               value="{{ old('tpa_company_name', $claim->tpa_company_name) }}" required>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" id="policy_number" name="policy_number" maxlength="50"
                               ...
                               value="{{ old('policy_number', $claim->policy_number) }}" required>
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="number" id="claim_amount" name="claim_amount" min="0.01" step="0.01"
                               ...
                               value="{{ old('claim_amount', $claim->claim_amount) }}" required>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <textarea id="documents" name="documents" rows="2"
                                  class="form-control @error('documents') is-invalid @enderror">{{ old('documents', $claim->documents) }}</textarea>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <textarea id="remarks" name="remarks" rows="2"
                                  class="form-control @error('remarks') is-invalid @enderror">{{ old('remarks', $claim->remarks) }}</textarea>
            ...
            <div class="mt-3">
                ...
                <a href="{{ route('medical.tpa.claims.show', $claim) }}" class="btn btn-secondary">Cancel</a>
            </div>
        </form>
    </div>
</div>
