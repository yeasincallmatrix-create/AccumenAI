    ...
    <div class="card-body">
        ...
        <form action="{{ route('medical.pharmacy.medicines.store') }}" method="POST">
            ...
            <div class="row">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="dosage_form" name="dosage_form" class="form-select @error('dosage_form') is-invalid @enderror" required>
                            ...
                            @foreach(config('medicine.dosage_forms') as $key => $label)
                                <option value="{{ $key }}" @selected(old('dosage_form') === $key)>{{ $label }}</option>
                            @endforeach
                        </select>
                ...
                <div class="col-12">
                    <hr class="my-2">
                    <h6 class="text-muted">DGDA Registry (optional)</h6>
                </div>
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" id="dgda_code" name="dgda_code" maxlength="100"
                               ...
                               value="{{ old('dgda_code') }}" placeholder="e.g. DGDA-DR-000123">
                ...
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" id="dgda_dar_number" name="dgda_dar_number" maxlength="100"
                               ...
                               value="{{ old('dgda_dar_number') }}" placeholder="e.g. DAR-45678">
