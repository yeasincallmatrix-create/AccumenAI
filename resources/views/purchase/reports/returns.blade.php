...
@forelse($rows as $r)<tr><td>{{ $r->return_number }}</td><td>{{ $r->supplier?->name }}</td><td><x-tdate :value="$r->return_date" fallback="Y-m-d" /></td><td class="text-end">{{ number_format($r->grand_total,2) }}</td></tr>
