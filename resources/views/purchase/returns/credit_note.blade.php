...
<p><strong>Supplier:</strong> {{ $return->supplier?->name }}<br><strong>Return:</strong> {{ $return->return_number }}<br><strong>Date:</strong> <x-tdate :value="$return->return_date" fallback="Y-m-d" /><br><strong>Status:</strong> {{ ucfirst($return->status) }}</p>
