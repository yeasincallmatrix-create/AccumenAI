...
<div class="row g-3">
    ...
    <div class="col-md-3"><label class="form-label">Return Date *</label><x-tdate-input name="return_date" :value="old('return_date', date('Y-m-d'))" class="form-control" required /></div>
