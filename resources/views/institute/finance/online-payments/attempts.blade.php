...
@section('title', 'Payment Attempts — ' . ($institute->name ?? 'AccumenAI'))

@section('content')
<div class="page-header mb-3">
    <h4 class="page-header-title"><i class="bi bi-list-ul me-1"></i>Online Payment Attempts</h4>
</div>
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($attempt->payment_id)
                                    <a href="{{ route('finance.payments.index') }}">#{{ $attempt->payment_id }}</a>
                                @else
                                    -
                                @endif
                            </td>
