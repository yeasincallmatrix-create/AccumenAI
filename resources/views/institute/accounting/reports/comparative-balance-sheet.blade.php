    ...
    <form class="filter-layout" method="GET">
        <div class="filter-search-row align-items-end flex-wrap">
            <div class="filter-span">
                ...
                <x-tdate-input class="form-control form-control-sm" name="current_date" value="{{ $current_date }}" />
            </div>
            <div class="filter-span">
                <label class="form-label mb-1">Prior Date</label>
                <x-tdate-input class="form-control form-control-sm" name="prior_date" value="{{ $prior_date }}" />
            </div>
            <div class="filter-span">
