...
@section('title', 'Add Sub-Industry — ' . $industry->name . ' — AccumenAI')
...
<nav aria-label="breadcrumb" class="mb-3">
    <ol class="breadcrumb mb-0">
        ...
        <li class="breadcrumb-item active">Add Sub-Industry</li>
    </ol>
</nav>

<div class="page-header">
    <div class="page-header-text">
        <h4 class="page-header-title">Add Sub-Industry to {{ $industry->name }}</h4>
    </div>
</div>
...
<div class="admin-card" style="max-width:600px">
    <form method="POST" action="{{ route('admin.industries.sub-industry.store', $industry) }}">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <div class="form-text">Unique within this industry scope. Use lowercase with underscores.</div>
        </div>
        <div class="row g-3">
            <div class="col-md-6">
        ...
        <div class="mb-3">
            <label class="form-label">Country Availability</label>
            <div class="form-text mb-2">Leave empty for global availability (all countries). Select specific countries to restrict availability.</div>
            <div class="border rounded p-3" style="max-height:200px;overflow-y:auto">
                @foreach ($countries as $country)
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="countries[]" value="{{ $country->id }}" id="country_{{ $country->id }}" {{ in_array($country->id, old('countries', [])) ? 'checked' : '' }}>
        ...
        <div class="d-flex gap-2">
            <button type="submit" class="btn btn-primary"><i class="bi bi-check-lg"></i> Create Sub-Industry</button>
