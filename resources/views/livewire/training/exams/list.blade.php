                ...
                @forelse ($exams as $exam)
                    <tr>
                        ...
                        @if (in_array('title', $visibleColumns, true))<td>
                            <a class="fw-semibold text-decoration-none" href="{{ route('training.exams.show', $exam) }}">{{ $exam->title }}</a>
                        </td>@endif
                        ...
                        @if (in_array('subjects', $visibleColumns, true))<td>{{ $exam->subjects->pluck('name')->filter()->implode(', ') ?: '—' }}</td>@endif
