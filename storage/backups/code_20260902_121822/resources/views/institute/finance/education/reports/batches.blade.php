...
@section('title', 'Batch Finance Report — AccumenAI')
@section('page_title', 'Finance')

@section('content')

<div class="standalone-heading">
    <h4>Batch-wise Finance Report</h4>
    <p>Billed, collected-relevant, outstanding, overdue and discounted amounts grouped by batch. Derived from the posted ledger via the finance core.</p>
    <div class="d-flex gap-2 flex-wrap">
        ...
        <a href="{{ route('finance.education.reports.courses') }}" class="btn btn-outline-secondary btn-sm"><i class="bi bi-bar-chart-fill me-1"></i>Course Report</a>
    </div>
</div>
