...
<div class="standalone-heading">
    <h4>Input VAT Detail</h4>
    <p>Debit postings to the Input VAT account (1201).</p>
    ...
    <div class="table-responsive">
        <table class="table align-middle mb-0">
            ...
            <tbody>
                ...
                @empty
                    <tr><td colspan="5" class="text-center text-muted py-4">No input VAT transactions found.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
