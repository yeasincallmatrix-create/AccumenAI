    ...
    <div class="filter-layout">
        <div class="filter-search-row align-items-end flex-wrap">
            <div class="filter-span">
                ...
                <input type="search" class="form-control form-control-sm" wire:model.live.debounce.300ms="search" placeholder="Supplier name, phone, or email">
            </div>
            <div class="filter-span">
...
<div class="admin-card">
    <div class="table-responsive">
        <table class="table align-middle mb-0">
            <thead>
                <tr>
                    <th>#</th>
                    <th wire:click="sortBy('name')" class="sortable">Supplier</th>
                    <th>Phone</th>
                    <th class="text-end">Current</th>
                    <th class="text-end">31–60</th>
                    <th class="text-end">61–90</th>
                    <th class="text-end">90+</th>
                    <th class="text-end" wire:click="sortBy('payable')" class="sortable">Payable</th>
            ...
            <tbody>
                @forelse ($suppliers as $supplier)
                    <tr>
                        ...
                        <td class="text-end">
                            <a href="{{ route('accounting.payables.statement', $supplier->id) }}" class="btn btn-outline-primary btn-sm">
                ...
                @empty
                    <tr>
                        <td colspan="10" class="text-center text-muted py-4">No outstanding payables.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
    ...
    @if ($suppliers->hasPages())
        <div class="p-2 border-top">{{ $suppliers->links('pagination::bootstrap-5') }}</div>
    @endif
</div>
</div>
