    ...
    <div class="filter-layout">
        <div class="filter-search-row align-items-end flex-wrap">
            <div class="filter-span">
                ...
                <input type="search" class="form-control form-control-sm" wire:model.live.debounce.300ms="search" placeholder="Journal no, account, memo">
            </div>
            <div class="filter-span">
...
<div class="admin-card">
    <div class="table-responsive">
        <table class="table align-middle mb-0">
            <thead>
                <tr>
                    <th wire:click="sortBy('je.journal_date')" class="sortable">Date</th>
                    <th wire:click="sortBy('j.journal_no')" class="sortable">Journal</th>
                    <th>Account</th>
                    <th>Description</th>
                    <th>Created By</th>
                    <th class="text-end" wire:click="sortBy('je.debit')" class="sortable">Debit</th>
                    <th class="text-end" wire:click="sortBy('je.credit')" class="sortable">Credit</th>
