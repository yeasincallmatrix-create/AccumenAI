...
<div class="page-header">
    <div class="page-header-text">
        ...
        <p class="page-header-desc">Platform-wide academic subject catalog</p>
    </div>
</div>
...
<div class="filter-card">
    <form class="filter-layout" method="GET" action="{{ route('admin.classes.subjects') }}">
        ...
        <div class="filter-search-row align-items-end">
            ...
            <div class="filter-actions">
                ...
                <a class="btn btn-outline-secondary btn-sm" href="{{ route('admin.classes.subjects') }}" title="Reset filters"><i class="bi bi-arrow-counterclockwise"></i> Reset</a>
            </div>
...
(function () {
    ...
    if (table && colChecks.length) {
        ...
        saveCols = function () {
            ...
            fetch('{{ route('admin.classes.subjects-columns') }}', {
                method: 'POST',
                headers: {
    ...
    if (csvBtn) { csvBtn.addEventListener('click', function () { exportTable('academic-subjects.csv'); }); }
    var excelBtn = document.getElementById('exportExcelBtn');
    if (excelBtn) { excelBtn.addEventListener('click', function () { exportTable('academic-subjects.xls'); }); }
})();
</script>
@endpush