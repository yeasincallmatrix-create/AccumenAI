...
@section('title', 'Class Archive — AccumenAI')
...
<div class="page-header">
    <div class="page-header-text">
        <h4 class="page-header-title">Class Archive</h4>
        <p class="page-header-desc">Archived class batches across institutes</p>
    </div>
</div>
...
<div class="filter-card">
    <form class="filter-layout" method="GET" action="{{ route('admin.classes.archive') }}">
        ...
        <div class="filter-search-row align-items-end">
            ...
            <div class="filter-actions">
                ...
                <a class="btn btn-outline-secondary btn-sm" href="{{ route('admin.classes.archive') }}" title="Reset filters"><i class="bi bi-arrow-counterclockwise"></i> Reset</a>
            </div>
...
<div class="admin-card">
    ...
    <div class="table-toolbar">
        <div class="toolbar-info">
            ...
            <span class="text-muted ms-2 d-none d-lg-inline">Classes archived by their institute.</span>
        </div>
    ...
    <div class="table-responsive">
        <table class="table align-middle mb-0" id="archiveTable">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="8" class="text-center text-muted py-4">No archived class batches found.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
    ...
    <div class="mt-4 d-flex flex-column align-items-center gap-2">
        ...
        <span class="text-muted small">{{ $items->total() }} archived classes</span>
    </div>
</div>
@endsection
...
(function () {
    ...
    if (csvBtn) { csvBtn.addEventListener('click', function () { exportTable('class-archive.csv'); }); }
    var excelBtn = document.getElementById('exportExcelBtn');
    if (excelBtn) { excelBtn.addEventListener('click', function () { exportTable('class-archive.xls'); }); }
})();
</script>
@endpush