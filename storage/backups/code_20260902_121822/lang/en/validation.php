...
return [
    ...
    */
    ...
    'not_regex_in' => 'The :attribute format is invalid.',
    'regex_in' => 'The :attribute format is invalid.',
    ...
    | of "email". This simply helps our messages to become more fluent.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | The following language lines are used to swap internal rule placeholder
    | messages with something more reader friendly such as "E-Mail Address"
    | instead of "email". This simply helps our messages to become more fluent.
    |
    */
